...
def render():
    ...
    if st.session_state.get("demo_mode", False):
        ...
        st.markdown(
            ...
            'Q¡uieres un diagnostico como este para tu espacio?</div>'
            '<div style="font-size:0.9rem;color:#2D6A4F;line-height:1.7;margin-bottom:0.8rem;">'
            'LivLin realiza diagnosticos regenerativos para hogares, organizaciones, empresas '
            ...
            '<div style="font-size:0.75rem;color:#40916C;margin-top:0.5rem;">'
             ·Activa el potencial para una vida regenerativa</div>'
            '</div>', unsafe_allow_html=True)
