"""Indagación Regenerativa v13 — LivLin · Multi-usuario + Google Drive."""
...
def _login_page():
    ...
    with cc:
        ...
        st.markdown('<p style="text-align:center;font-size:0.72rem;color:#aaa;margin-top:1rem;">v13 · LivLin Permacultura Urbana</p>', unsafe_allow_html=True)
...
def _sidebar():
    ...
    with st.sidebar:
        ...
        st.markdown('<div style="text-align:center;padding:0 0 0.4rem;">'
            '<span style="font-size:0.72rem;color:#40916C;font-style:italic;">Indagación Regenerativa v13</span></div>',
            unsafe_allow_html=True)
        st.markdown("---")
