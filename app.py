"""Indagación Regenerativa v2.0 — LivLin · Multi-usuario + Google Drive."""
    ...
    with cc:
        ...
        if st.button("🌿 Ingresar", use_container_width=True, type="primary", key="btn_login"):
            ...
            if user:
                ...
                st.session_state.pop("_visits_cache_v2.0", None)
        ...
        st.markdown('<p style="text-align:center;font-size:0.72rem;color:#aaa;margin-top:1rem;">v2.0 · LivLin Permacultura Urbana</p>', unsafe_allow_html=True)
...
def _sidebar():
    ...
    with st.sidebar:
        ...
        st.markdown('<div style="text-align:center;padding:0 0 0.4rem;">'
            '<span style="font-size:0.72rem;color:#40916C;font-style:italic;">Indagación Regenerativa v2.0</span></div>',
            unsafe_allow_html=True)
        st.markdown("---")
